	...
	<dmtags:span width="12">
		<dmtags:widget title="${i18nRating}" style="noTable"
			...
			<form:form method="post" action="add/${participant.pid}"
				...
				<form:input path="participant.pid" value="${participant.pid}"
					type="hidden" />
				...
				<div class="control-group">
					...
					<div class="span6">
						<form:textarea path="proCritique" maxlength="255" rows="6" />
						<br />
				...
				<div class="control-group">
					...
					<div class="span6">
						<form:textarea path="contraCritique" maxlength="255" rows="6" />
						<br />
						<spring:message code="help.maxChars" />
					</div>
		...
		<dmtags:widget title="${i18nOverview}" style="table" icon="icon-list">
			<display:table name="ratingList" id="rating"
				...
				<display:column>
					...
					<a href="delete/${participant.pid }/${rid}" class="openDialog"
						id="${rid}"><spring:message code="label.delete" /></a>
	...
	$("#dialog-confirm").dialog(
			{
				...
				buttons : {
					"OK" : function() {
						document.location = "delete/${participant.pid}/"
								+ $("#deleteId").text();
						$("#deleteId").text("");
						$(this).dialog("close");
					},
