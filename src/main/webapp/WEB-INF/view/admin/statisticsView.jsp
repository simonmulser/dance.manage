...
var myChart = new Chart(document.getElementById("canvasStyle").getContext("2d"));
...
var myLine = new Chart(document.getElementById("canvasLevel").getContext("2d")).Bar(barChartData, options);
