...
public class SatValidator {
    ...
    public Map<Integer, Performance> validatePerformancePlan() {
        ...
        // this.courseList1 =
        // validateMultipleCoursesInSamePerformance(this.courseList1,
        // this.participantList);
        // this.courseList2 =
        // validateMultipleCoursesInSamePerformance(this.courseList2,
        // this.participantList);
        // this.courseList3 =
        // validateMultipleCoursesInSamePerformance(this.courseList3,
        // this.participantList);
        //
    ...
    private List<Course> validateMultipleCoursesInSamePerformance(
        ...
        for (int k = 0; k < participantNotValidated.size(); k++) {
            for (CourseParticipant currentCoPa : participantList.get(
                    participantNotValidated.get(k)).getCourseParticipants()) {
